...
public class MyTest2Script : MonoBehaviour {
	...
	void Start () {
		...
		//htmlDocument = GetComponent<Manager>().Document;
		...
		var ele_color = htmlDocument.body.getElementById ("btn_color");
		...
		var ele_bigger = htmlDocument.body.getElementById ("btn_bigger");
