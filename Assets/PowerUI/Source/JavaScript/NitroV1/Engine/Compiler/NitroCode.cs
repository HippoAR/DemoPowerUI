...
namespace Nitro{
	...
	public class NitroCode{
		...
		/// <summary>True if variable resolving is done AOT. This generally speeds up development with Nitro, but isn't compatible with typical JS.
		/// Flip this with "use aot"; and "use jit";</summary>
		public static bool AotMode=true;
		...
		/// <summary>Searches for all the types with the given name by first performing an alias lookup.</summary>
		/// <param name="name">The type name to search for.</param>
		/// <returns>A system type if found; null otherwise.</returns>
		...
		/// <summary>The main class of this code.</summary>
		public CompiledClass MainClass{
			get{
				return BaseClass;
			}
		}
