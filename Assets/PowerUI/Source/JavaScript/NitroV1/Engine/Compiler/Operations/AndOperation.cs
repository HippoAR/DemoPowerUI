...
namespace Nitro{
	...
	/// <summary>
	/// Represents the logical and (A&&B) operation.
	/// </summary>
	
	public class AndOperation:Operation{
	
		public AndOperation(CompiledMethod method,CompiledFragment input0,CompiledFragment input1):base(method){
			Input0=input0;
			Input1=input1;
		}
