...
namespace Nitro{
	...
	/// <summary>
	/// Represents a right shift (A>>B) operation.
	/// </summary>
	
	public class ShiftRightOperation:Operation{
		
		public ShiftRightOperation(CompiledMethod method,CompiledFragment input0,CompiledFragment input1):base(method){
			Input0=input0;
			Input1=input1;
		}
